...
export const mockProductions: Production[] = [
  {
    ...
    description: 'Primera sesión fotográfica profesional. Incluye diferentes poses y estilos editoriales.',
    coverImage: '/src/assets/images/models/production_1_item_1.JPG',
    category: 'Editorial',
    date: new Date('2024-11-01'),
    location: 'Estudio Principal',
    photographer: 'Franco',
    photos: generatePhotos(1, 3),
    tags: ['editorial', 'studio', 'profesional'],
  },
  {
    id: '2',
